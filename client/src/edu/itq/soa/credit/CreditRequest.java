...
public class CreditRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Nombres
     */
    protected edu.itq.soa.credit.Nombres_type1 localNombres;

    /**
     * field for ApellidoPaterno
     */
    protected edu.itq.soa.credit.ApellidoPaterno_type1 localApellidoPaterno;

    /**
     * field for ApellidoMaterno
     */
    protected edu.itq.soa.credit.ApellidoMaterno_type1 localApellidoMaterno;

    /**
     * field for Curp
     */
    protected edu.itq.soa.credit.Curp_type1 localCurp;
     ...
     */
    public edu.itq.soa.credit.Nombres_type1 getNombres() {
        return localNombres;
    }
     ...
     * @param param Nombres
     */
    public void setNombres(edu.itq.soa.credit.Nombres_type1 param) {
     ...
     */
    public edu.itq.soa.credit.ApellidoPaterno_type1 getApellidoPaterno() {
    ...
    public void setApellidoPaterno(
        edu.itq.soa.credit.ApellidoPaterno_type1 param) {
     ...
     */
    public edu.itq.soa.credit.ApellidoMaterno_type1 getApellidoMaterno() {
    ...
    public void setApellidoMaterno(
        edu.itq.soa.credit.ApellidoMaterno_type1 param) {
     ...
     */
    public edu.itq.soa.credit.Curp_type1 getCurp() {
        return localCurp;
    }
     ...
     * @param param Curp
     */
    public void setCurp(edu.itq.soa.credit.Curp_type1 param) {
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"creditRequest".equals(type)) {
                            ...
                            return (CreditRequest) edu.itq.soa.credit.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setNombres(edu.itq.soa.credit.Nombres_type1.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setApellidoPaterno(edu.itq.soa.credit.ApellidoPaterno_type1.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setApellidoMaterno(edu.itq.soa.credit.ApellidoMaterno_type1.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setCurp(edu.itq.soa.credit.Curp_type1.Factory.parse(
                            reader));
