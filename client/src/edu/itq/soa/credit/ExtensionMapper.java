...
public class ExtensionMapper {
    public static java.lang.Object getTypeObject(
        ...
        if ("http://itq.edu/soa/credit".equals(namespaceURI) &&
            ...
            return edu.itq.soa.credit.Curp_type1.Factory.parse(reader);
        }

        if ("http://itq.edu/soa/credit".equals(namespaceURI) &&
                "apellidoMaterno_type1".equals(typeName)) {
            return edu.itq.soa.credit.ApellidoMaterno_type1.Factory.parse(reader);
        }

        if ("http://itq.edu/soa/credit".equals(namespaceURI) &&
                "nombres_type1".equals(typeName)) {
            return edu.itq.soa.credit.Nombres_type1.Factory.parse(reader);
        }

        if ("http://itq.edu/soa/credit".equals(namespaceURI) &&
                "apellidoPaterno_type1".equals(typeName)) {
            return edu.itq.soa.credit.ApellidoPaterno_type1.Factory.parse(reader);
        }
